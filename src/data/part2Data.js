export const part2Data = {
  ...
  "Museum club": {
    ...
    "vocabulary": [
      ...
      "✨ [lợi ích - Vo]: <strong>enhance my creativity</strong> (nâng cao sự sáng tạo), <strong>widen my knowledge about history</strong> (mở rộng kiến thức về lịch sử), <strong>appreciate cultural values</strong> (trân trọng các giá trị văn hóa), <strong>gain a deeper understanding of art</strong> (hiểu sâu hơn về nghệ thuật), <strong>get inspiration for my work</strong> (tìm nguồn cảm hứng cho công việc), <strong>spend quality time with my family</strong> (dành thời gian chất lượng bên gia đình), <strong>broaden my horizons</strong> (mở mang tầm mắt)"
    ]
  },
  "Writing club": {
