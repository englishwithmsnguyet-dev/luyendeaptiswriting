export const part2Data = {
  "Art club": {
    "text": "Tell me a painting or a photo that you like.",
    "vi": "Hãy kể cho tôi nghe về một bức tranh hoặc bức ảnh mà bạn thích.",
    "samples": [
      {
        "en": "I am really keen on The Starry Night because it is very captivating. Enjoying it helps me enhance my creativity and relax after a long day.",
        "vi": "Tôi rất thích tác phẩm Đêm Đầy Sao vì nó rất cuốn hút. Thưởng thức nó giúp tôi nâng cao sự sáng tạo và thư giãn sau một ngày dài."
      },
      {
        "en": "My favorite is a picture of my hometown, which has a deep meaning. It is incredibly inspiring and allows me to find peace of mind easily.",
  ...
  "Food club": {
    "text": "When and where do you usually have meals?",
    "samples": [
      {
        "en": "I usually have meals at my home kitchen during the evening. It is a good way to stay healthy and improve my mood after a busy day.",
        "vi": "Tôi thường dùng bữa tại bếp nhà vào buổi tối. Đây là một cách tốt để duy trì sức khỏe và cải thiện tâm trạng sau một ngày bận rộn."
      },
      {
  ...
  "Beautiful homes club": {
    "text": "Why do you want to join the Beautiful homes club?",
    "samples": [
      {
        "en": "I decided to join this club because I am passionate about decorating my house. It allows me to turn my house into a home.",
  ...
  "Sports club": {
    "text": "Why did you decide to join the club?",
    "samples": [
      {
        "en": "I decided to join this club because I am passionate about playing sports. It allows me to stay in good shape.",
        "vi": "Tôi quyết định tham gia câu lạc bộ vì đam mê sở thích này. Nó cho phép tôi đạt được nhiều lợi ích thiết thực."
      },
      {
  ...
  "Book club": {
    "text": "I am a final year student so I need to find and research a lot of materials such as books and scientific journals. Why did you join?",
    "samples": [
      {
        "en": "I decided to join this club because I am passionate about reading books. It allows me to widen my knowledge.",
        "vi": "Tôi quyết định tham gia câu lạc bộ vì đam mê sở thích này. Nó cho phép tôi đạt được nhiều lợi ích thiết thực."
      },
      {
  ...
  "Healthy club": {
    "text": "Tell me the classes you want to take and what times and days are suitable for you.",
    "samples": [
      {
        "en": "I can attend classes every Monday evening and I would like to learn yoga. It helps me stay in good shape effectively.",
        "vi": "Tôi có thể tham gia các lớp học vào mỗi tối thứ Hai và tôi muốn học yoga. Việc này giúp tôi giữ dáng hiệu quả."
      },
      {
  ...
  "Business club": {
    "text": "Where do you usually go shopping?",
    "samples": [
      {
        "en": "I usually go shopping at fashion boutiques because it is very trendy. It helps me stay fashionable and boost my confidence.",
        "vi": "Tôi thường đi mua sắm ở cửa hàng thời trang vì nó rất hợp thời trang. Nó giúp tôi giữ phong cách và tăng tự tin."
      },
      {
        "en": "I tend to go shopping at supermarkets at the weekend. It is incredibly well-organized and allows me to buy essential items easily.",
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>trendy</strong> (hợp thời trang), <strong>well-organized</strong> (được sắp xếp tốt), <strong>diverse</strong> (đa dạng), <strong>affordable</strong> (giá cả phải chăng), <strong>luxurious</strong> (sang trọng), <strong>time-saving</strong> (tiết kiệm thời gian)",
      "✨ [lợi ích - Vo]: <strong>stay fashionable</strong> (giữ phong cách thời trang), <strong>buy essential items easily</strong> (mua vật dụng thiết yếu dễ dàng), <strong>compare prices easily</strong> (so sánh giá dễ dàng), <strong>find exclusive products</strong> (tìm những sản phẩm độc quyền), <strong>save my living costs</strong> (tiết kiệm chi phí sinh hoạt), <strong>enjoy a great shopping experience</strong> (tận hưởng trải nghiệm mua sắm tuyệt vời)"
    ]
  },
  "Home living club": {
    ...
    "samples": [
      {
        "en": "I would like to tell you about my cozy apartment, which is very comfortable and well-decorated. It helps me find peace of mind and relax.",
        "vi": "Tôi muốn kể cho bạn về căn hộ ấm cúng của mình, nơi rất thoải mái và được trang trí đẹp. Nó giúp tôi tìm sự bình yên và thư giãn."
      },
      {
  ...
  "Car club": {
    "text": "Do you usually travel by car?",
    "samples": [
      {
        "en": "Yes, I usually travel by car to my workplace every morning. It is a good way to save my commuting time and reduce travel fatigue.",
        "vi": "Vâng, tôi thường đi làm bằng ô tô mỗi buổi sáng. Đây là cách tốt để tiết kiệm thời gian đi lại và giảm mệt mỏi."
      },
      {
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>convenient</strong> (tiện lợi), <strong>comfortable</strong> (thoải mái), <strong>time-saving</strong> (tiết kiệm thời gian), <strong>eco-friendly</strong> (thân thiện với môi trường), <strong>cost-effective</strong> (tiết kiệm chi phí), <strong>safe and secure</strong> (an toàn và bảo đảm)",
  ...
  "Language club": {
    "text": "Tell me your free time and interests.",
    "samples": [
      {
        "en": "I am really keen on planting trees because it is very peaceful. Enjoying it helps me escape from daily stress and breathe fresh air.",
        "vi": "Tôi rất thích hoạt động này vì nó rất yên bình. Thưởng thức hoạt động này giúp tôi thoát khỏi căng thẳng hàng ngày và cảm thấy tốt hơn."
      },
      {
        "en": "My favorite is hiking in the mountains, which has a refreshing vibe. It is incredibly active and allows me to stay in good shape easily.",
  ...
  "Cinema club": {
    "text": "When and how often do you watch films?",
    "samples": [
      {
        "en": "I usually watch films once a week in the evening. It is a good way to find peace of mind and relax after a long day.",
        "vi": "Tôi thường xem phim một lần một tuần vào buổi tối. Đây là một cách tốt để tìm sự bình yên trong tâm trí và thư giãn sau một ngày dài."
      },
      {
    ...
    "vocabulary": [
      ...
      "✨ [thời gian]: <strong>in the evening</strong> (vào buổi tối), <strong>on weekends</strong> (vào cuối tuần), <strong>in my free time</strong> (trong thời gian rảnh), <strong>late at night</strong> (vào đêm khuya), <strong>during my holidays</strong> (trong kỳ nghỉ), <strong>after working hours</strong> (sau giờ làm việc)",
  ...
  "Language club 2": {
    ...
    "samples": [
      ...
      {
        "en": "I tend to use foreign languages when communicating with foreigners. It is incredibly helpful and allows me to build my confidence.",
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>essential</strong> (thiết yếu), <strong>practical</strong> (thực tế), <strong>helpful</strong> (hữu ích), <strong>crucial</strong> (quan trọng), <strong>indispensable</strong> (không thể thiếu), <strong>advantageous</strong> (có lợi)",
      "✨ [lợi ích - Vo]: <strong>understand other cultures</strong> (hiểu văn hóa khác), <strong>build my confidence</strong> (xây dựng sự tự tin), <strong>expand my knowledge</strong> (mở rộng kiến thức), <strong>boost my career prospects</strong> (nâng cao triển vọng nghề nghiệp), <strong>communicate globally</strong> (giao tiếp toàn cầu), <strong>avoid misunderstandings</strong> (tránh hiểu lầm)"
    ]
  },
  "Travel club 2": {
  ...
  "College club": {
    "text": "Please tell us about the days and times you can attend courses and what you would like to study.",
    "samples": [
      {
        "en": "I can attend courses on Monday and Wednesday at 7 PM and I would like to study business communication. It helps me improve myself effectively.",
        "vi": "Tôi có thể tham gia các khóa học vào thứ Hai và thứ Tư lúc 7 giờ tối và tôi muốn học giao tiếp kinh doanh. Việc này giúp tôi cải thiện bản thân hiệu quả."
      },
      {
  ...
  "Movie club": {
    ...
    "samples": [
      {
        "en": "I decided to join this club because I am passionate about watching movies. It allows me to find peace of mind.",
        "vi": "Tôi quyết định tham gia câu lạc bộ vì đam mê sở thích này. Nó cho phép tôi đạt được nhiều lợi ích thiết thực."
      },
      {
  ...
  "Walking club": {
    ...
    "samples": [
      ...
      {
        "en": "It was a memorable day when I did this activity at the city center last weekend. It was incredibly fascinating and helped me a lot.",
  ...
  "Community club": {
    "text": "Why did you join this Community club?",
    "samples": [
      {
        "en": "I decided to join this club because I am passionate about doing volunteer work. It allows me to contribute to the society.",
        "vi": "Tôi quyết định tham gia câu lạc bộ vì đam mê sở thích này. Nó cho phép tôi đạt được nhiều lợi ích thiết thực."
      },
      {
  ...
  "Museum club": {
    "text": "Tell me the last time you went to a museum.",
    "samples": [
      {
        "en": "The last time I did this was about two weeks ago. It was a very inspiring experience because I had the chance to improve myself.",
        "vi": "Lần cuối cùng tôi làm việc này là khoảng hai tuần trước. Đó là một trải nghiệm rất truyền cảm hứng vì tôi có cơ hội cải thiện bản thân."
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>inspiring</strong> (truyền cảm hứng), <strong>eye-opening</strong> (mở mang tầm mắt), <strong>educational</strong> (mang tính giáo dục), <strong>thought-provoking</strong> (gợi suy nghĩ), <strong>magnificent</strong> (tráng lệ), <strong>unforgettable</strong> (khó quên)",
      "✨ [lợi ích - Vo]: <strong>enhance my creativity</strong> (nâng cao sự sáng tạo), <strong>widen my knowledge about history</strong> (mở rộng kiến thức về lịch sử), <strong>appreciate cultural values</strong> (trân trọng các giá trị văn hóa), <strong>gain a deeper understanding of art</strong> (hiểu sâu hơn về nghệ thuật), <strong>get inspiration for my work</strong> (tìm nguồn cảm hứng cho công việc), <strong>spend quality time with my family</strong> (dành thời gian chất lượng bên gia đình)"
    ]
  },
  "Writing club": {
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>inspiring</strong> (truyền cảm hứng), <strong>thought-provoking</strong> (gợi suy nghĩ), <strong>fascinating</strong> (hấp dẫn), <strong>rewarding</strong> (đáng giá), <strong>meaningful</strong> (ý nghĩa), <strong>therapeutic</strong> (có tính trị liệu)",
      "✨ [lợi ích - Vo]: <strong>express my feelings</strong> (thể hiện cảm xúc), <strong>develop my imagination</strong> (phát triển trí tưởng tượng), <strong>improve my writing skills</strong> (cải thiện kỹ năng viết), <strong>organize my thoughts clearly</strong> (sắp xếp suy nghĩ rõ ràng), <strong>reduce stress effectively</strong> (giảm căng thẳng hiệu quả), <strong>record my precious memories</strong> (ghi lại những kỷ niệm quý giá)"
    ]
  },
  "Computer club": {
    "text": "When and where do you use a computer?",
    "samples": [
      {
        "en": "I usually use my laptop at my office during working hours. It is a good way to improve my digital skills and study more effectively.",
        "vi": "Tôi thường dùng laptop tại văn phòng trong giờ làm việc. Đây là cách tốt để cải thiện kỹ năng công nghệ và học tập hiệu quả hơn."
  ...
  "Music club": {
    "text": "What do you usually do when you listen to music?",
    "samples": [
      {
        "en": "I usually do the housework when I listen to music. It is a good way to boost my emotional well-being and regain my energy.",
        "vi": "Tôi thường làm việc nhà khi nghe nhạc. Đây là cách tốt để nâng cao sức khỏe tinh thần và nạp lại năng lượng."
      },
      {
  ...
  "Fashion club": {
    "text": "When was the last time you went shopping for clothes?",
    "samples": [
      {
        "en": "The last time I did this was about two weeks ago. It was a very inspiring experience because I had the chance to improve myself.",
        "vi": "Lần cuối cùng tôi làm việc này là khoảng hai tuần trước. Đó là một trải nghiệm rất truyền cảm hứng vì tôi có cơ hội cải thiện bản thân."
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>exciting</strong> (thú vị), <strong>rewarding</strong> (đáng giá), <strong>fun</strong> (vui vẻ), <strong>glamorous</strong> (lộng lẫy), <strong>fashionable</strong> (thời trang), <strong>fabulous</strong> (tuyệt vời)",
      "✨ [lợi ích - Vo]: <strong>update my wardrobe</strong> (cập nhật tủ quần áo), <strong>boost my confidence</strong> (tăng sự tự tin), <strong>express my personal style</strong> (thể hiện phong cách cá nhân), <strong>keep up with the latest trends</strong> (bắt kịp xu hướng mới nhất), <strong>feel good about myself</strong> (cảm thấy tốt về bản thân), <strong>stand out from the crowd</strong> (trở nên nổi bật trước đám đông)"
    ]
  },
  "Cooking club": {
    "text": "Tell me about the day and time you can join the club and which food/dish you want to cook.",
    "samples": [
      {
        "en": "I can join the club on Sundays at 8 AM and I want to cook traditional Pho. It is a great opportunity to maintain a healthy lifestyle.",
        "vi": "Tôi có thể tham gia câu lạc bộ vào Chủ nhật lúc 8 giờ sáng và tôi muốn nấu phở truyền thống. Đây là cơ hội tuyệt vời để duy trì lối sống lành mạnh."
      },
      {
  ...
  "Nature club": {
    "text": "Please tell me about your free time and hobbies.",
    "samples": [
      {
        "en": "I am really keen on planting trees because it is very peaceful. Enjoying it helps me escape from daily stress and breathe fresh air.",
        "vi": "Tôi rất thích hoạt động này vì nó rất yên bình. Thưởng thức hoạt động này giúp tôi thoát khỏi căng thẳng hàng ngày và cảm thấy tốt hơn."
  ...
  "Debate club": {
    "text": "What do you usually talk about with your friend?",
    "samples": [
      {
        "en": "I usually talk about current events with my best friend. It is a good way to widen my knowledge and improve my communication skills.",
        "vi": "Tôi thường nói về các sự kiện thời sự với bạn thân. Đây là một cách tốt để mở rộng kiến thức và cải thiện kỹ năng giao tiếp."
  ...
  "Outdoor club": {
    "text": "Which outdoor activities do you like? Why?",
    "samples": [
      {
        "en": "I am really keen on planting trees because it is very peaceful. Enjoying it helps me escape from daily stress and breathe fresh air.",
        "vi": "Tôi rất thích hoạt động này vì nó rất yên bình. Thưởng thức hoạt động này giúp tôi thoát khỏi căng thẳng hàng ngày và cảm thấy tốt hơn."
  ...
  "English club": {
    ...
    "samples": [
      {
        "en": "I often use the internet to read international news. It is very convenient and helps me widen my knowledge easily.",
        "vi": "Tôi thường dùng internet để đọc tin tức quốc tế. Rất tiện lợi và giúp tôi mở rộng kiến thức dễ dàng."
      },
      {
        "en": "I tend to use the internet to watch English videos. It is incredibly helpful and allows me to improve my English skills.",
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>essential</strong> (thiết yếu), <strong>convenient</strong> (tiện lợi), <strong>helpful</strong> (hữu ích), <strong>informative</strong> (nhiều thông tin), <strong>life-changing</strong> (thay đổi cuộc đời), <strong>practical</strong> (thực tế)",
      "✨ [lợi ích - Vo]: <strong>widen my knowledge</strong> (mở rộng kiến thức), <strong>improve my English skills</strong> (cải thiện kỹ năng tiếng Anh), <strong>stay updated with global events</strong> (cập nhật sự kiện toàn cầu), <strong>learn from experts worldwide</strong> (học hỏi từ các chuyên gia trên toàn thế giới), <strong>access endless resources</strong> (truy cập tài nguyên vô tận), <strong>work remotely effectively</strong> (làm việc từ xa hiệu quả)"
    ]
  },
  "Photography club": {
    "text": "Please tell me the last time you took a picture.",
    "samples": [
      {
        "en": "The last time I did this was about two weeks ago. It was a very inspiring experience because I had the chance to improve myself.",
        "vi": "Lần cuối cùng tôi làm việc này là khoảng hai tuần trước. Đó là một trải nghiệm rất truyền cảm hứng vì tôi có cơ hội cải thiện bản thân."
  ...
  "Nature club 2": {
    "text": "What do you like doing when you spend time outdoors?",
    "samples": [
      {
        "en": "I am really keen on planting trees because it is very peaceful. Enjoying it helps me escape from daily stress and breathe fresh air.",
        "vi": "Tôi rất thích hoạt động này vì nó rất yên bình. Thưởng thức hoạt động này giúp tôi thoát khỏi căng thẳng hàng ngày và cảm thấy tốt hơn."
  ...
  "Reading club": {
    "text": "When was the last time you read a book and how was the book?",
    "samples": [
      {
        "en": "The last time I did this was about two weeks ago. It was a very inspiring experience because I had the chance to improve myself.",
        "vi": "Lần cuối cùng tôi làm việc này là khoảng hai tuần trước. Đó là một trải nghiệm rất truyền cảm hứng vì tôi có cơ hội cải thiện bản thân."
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>informative</strong> (nhiều thông tin), <strong>inspiring</strong> (truyền cảm hứng), <strong>fascinating</strong> (hấp dẫn), <strong>thought-provoking</strong> (gợi suy nghĩ), <strong>eye-opening</strong> (mở mang tầm mắt), <strong>meaningful</strong> (ý nghĩa)",
      "✨ [lợi ích - Vo]: <strong>widen my knowledge</strong> (mở rộng kiến thức), <strong>expand my vocabulary</strong> (mở rộng vốn từ vựng), <strong>improve my critical thinking</strong> (cải thiện tư duy phản biện), <strong>escape from reality for a while</strong> (thoát khỏi thực tại một lúc), <strong>gain valuable life lessons</strong> (thu được những bài học cuộc sống giá trị), <strong>boost my imagination</strong> (nâng cao trí tưởng tượng)"
    ]
  },
  "Fitness club": {
    "text": "Please talk about the last time you went for a run.",
    "samples": [
      {
        "en": "The last time I did this was about two weeks ago. It was a very inspiring experience because I had the chance to improve myself.",
        "vi": "Lần cuối cùng tôi làm việc này là khoảng hai tuần trước. Đó là một trải nghiệm rất truyền cảm hứng vì tôi có cơ hội cải thiện bản thân."
    ...
    "vocabulary": [
      ...
      "✨ [tính từ]: <strong>energetic</strong> (tràn đầy năng lượng), <strong>refreshing</strong> (sảng khoái), <strong>exhausting but rewarding</strong> (mệt mỏi nhưng xứng đáng), <strong>challenging</strong> (đầy thử thách), <strong>invigorating</strong> (tiếp thêm sinh lực), <strong>satisfying</strong> (thỏa mãn)",
      "✨ [lợi ích - Vo]: <strong>burn calories</strong> (đốt cháy calo), <strong>strengthen cardiovascular health</strong> (tăng cường sức khỏe tim mạch), <strong>build muscle strength</strong> (Xây dựng sức mạnh cơ bắp), <strong>improve my physical endurance</strong> (cải thiện sức bền thể chất), <strong>relieve work pressure</strong> (giảm áp lực công việc), <strong>boost my immune system</strong> (tăng cường hệ miễn dịch)"
    ]
  },
  "Science club": {
    "text": "Why do you like science?",
    "samples": [
      {
        "en": "I decided to join this club because I am passionate about doing experiments. It allows me to widen my knowledge.",
        "vi": "Tôi quyết định tham gia câu lạc bộ vì đam mê sở thích này. Nó cho phép tôi đạt được nhiều lợi ích thiết thực."
      },
      {
