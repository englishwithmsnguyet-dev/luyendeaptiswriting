export const part4SlotHints = {
  "Walking club": {
    ...
    e2Topic: { en: "the monthly walking event to attract more members", vi: "sự kiện đi bộ hàng tháng nhằm thu hút thêm hội viên" },
    positive: true
  },
  "Fitness club": {
    ...
    e2Topic: { en: "the proposed 15% membership fee increase and equipment upgrade", vi: "đề xuất tăng 15% phí hội viên và nâng cấp thiết bị" },
    positive: false
  },
  "Art club": {
    ...
    e2Topic: { en: "the upcoming public talk and guest artist invitation", vi: "buổi nói chuyện công chúng sắp tới và việc mời nghệ sĩ" },
    positive: true
  },
  "Food club": {
    ...
    e2Topic: { en: "the upcoming talk show and live cooking demonstration", vi: "buổi tọa đàm ẩm thực sắp tới và hoạt động nấu ăn biểu diễn" },
    positive: true
  },
  "Social club": {
    ...
    e2Topic: { en: "the organization of monthly in-person gatherings", vi: "việc tổ chức các buổi gặp gỡ trực tiếp định kỳ hàng tháng" },
    positive: true
  },
  "Social club 2": {
    ...
    e2Topic: { en: "the upcoming face-to-face gatherings for adults and children", vi: "các buổi gặp mặt trực tiếp sắp tới cho người lớn và trẻ em" },
    positive: true
  },
  "Beautiful homes club": {
    ...
    e2Topic: { en: "the proposal to demolish older buildings in favor of modern housing blocks", vi: "đề xuất phá bỏ công trình cũ để xây dựng các tòa nhà hiện đại" },
    positive: false
  },
  "Living home club": {
    ...
    e2Topic: { en: "providing practical housing guidance and financial advice for young adults", vi: "cung cấp định hướng nhà ở và lời khuyên tài chính cho người trẻ" },
    positive: true
  },
  "Garden club": {
  ...
  "Garden club 2": {
    ...
    e2Topic: { en: "the municipal tree-planting initiatives and environmental greening proposals", vi: "các sáng kiến trồng cây của thành phố và đề xuất phủ xanh môi trường" },
    positive: true
  },
  "Sports club": {
    ...
    e2Topic: { en: "the organization of the upcoming sports tournament for youth members", vi: "công tác tổ chức giải thi đấu thể thao sắp tới cho các hội viên trẻ" },
    positive: true
  },
  "Film club": {
    ...
    e2Topic: { en: "the upcoming presentation by the renowned film critic and audience engagement", vi: "buổi nói chuyện sắp tới của nhà phê bình phim nổi tiếng và cách thu hút khán giả" },
    positive: true
  },
  "Car club": {
    ...
    e2Topic: { en: "the candidate nominations for the upcoming trans-European driving tour", vi: "việc đề cử ứng viên cho chuyến lưu diễn lái xe xuyên châu Âu sắp tới" },
    positive: true
  },
  "Community club": {
    ...
    e2Topic: { en: "member recruitment drives and creative development for future community projects", vi: "chiến dịch tuyển hội viên và phát triển sáng tạo các dự án cộng đồng" },
    positive: true
  },
  "Music club": {
    ...
    e2Topic: { en: "the noise complaints raised by local residents regarding our evening performances", vi: "những phàn nàn về tiếng ồn từ cư dân xung quanh đối với các buổi biểu diễn" },
    positive: false
  },
  "English club 1": {
    ...
    e2Topic: { en: "the last-minute cancellation of our scheduled Talk Show and contingency measures", vi: "việc hủy bỏ đột xuất buổi Talk Show và các biện pháp ứng phó" },
    positive: false
  },
  "English club 2": {
    ...
    e2Topic: { en: "the upcoming sponsored talk show highlighting the advantages of learning English", vi: "buổi tọa đàm tài trợ sắp tới nêu bật các lợi ích của việc học tiếng Anh" },
    positive: true
  },
  "Book club 1": {
    ...
    e2Topic: { en: "the author meet-and-greet event designed to engage both youth and elderly members", vi: "sự kiện gặp gỡ tác giả nhằm kết nối độc giả trẻ và người cao tuổi" },
    positive: true
  },
  "Book club 2": {
    ...
    e2Topic: { en: "the proposed municipal plan to shut down our local public library", vi: "kế hoạch của thành phố về việc đóng cửa thư viện công cộng địa phương" },
    positive: false
  }
};
